...
export default function TerminalChatBubble({
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end gap-3 sm:bottom-6 sm:right-6">
      {open && (
        <div
          className="mr-chat-panel flex w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-xl border border-mr-green/30 bg-mr-black shadow-2xl sm:w-[360px]"
          role="dialog"
          aria-label="Terminal"
        >
          <div className="flex items-center justify-between border-b border-mr-green/20 bg-mr-dark px-3 py-2">
