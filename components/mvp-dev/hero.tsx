    ...
    return (
        <section className='h-screen max-w-full'>
            <div className="h-[50rem] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] fixed flex items-center justify-center -z-50">
                ...
                <p className="text-4xl sm:text-7xl font-bold relative bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-primary py-8 text-center sm:text-left">
                    Mit der Idee zum MVP<br />in nur einem Monat
                </p>
            </div>
        </section>
    )
