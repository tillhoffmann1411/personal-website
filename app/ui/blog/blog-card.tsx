...
const BlogCard: React.FC<Props> = ({ link, thumbnail, title, description = '' }) => {
    return (
        <div className="flex flex-col h-full justify-between bg-gray-200 rounded-2xl dark:bg-gray-900">
            ...
            <div className="p-5 h-full flex flex-col place-content-between">
                <div>
                    ...
                    <p className="mb-3 text-gray-700 dark:text-gray-300">{description.replace(/<\/?[^>]+(>|$)/g, "").substring(0, 75)}...</p>
                </div>
